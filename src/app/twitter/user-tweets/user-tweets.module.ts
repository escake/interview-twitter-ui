...
import { UserTweetsOverviewComponent } from './user-tweets-overview/user-tweets-overview.component';
...
@NgModule({
  ...
  declarations: [UserTweetsContainerComponent, UserTweetsViewComponent, UserTweetsTableComponent, UserTweetsOverviewComponent],
})
